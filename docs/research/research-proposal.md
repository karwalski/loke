> **Status note (2026-09-19):** this is a research *proposal*. Its methodology is sound and largely
> unimplemented. Any figure in this document is a target or an illustration, never a measurement.
> Measured figures live only in `docs/metrics-baseline.md`.
